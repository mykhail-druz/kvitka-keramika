  ...
  return (
    ...
    >
      <div className="w-[90%] md:w-[90%] 2xl:w-2/3 flex flex-col-reverse md:flex-row justify-between space-x-0">
        <motion.div custom={8} variants={itemVariants} className="flex flex-col items-start space-y-12 p-12 bg-beige md:w-[50%]">
          <motion.p custom={10} variants={itemVariants} className="font-bold text-4xl text-brown">
            Керамічна студія &quot;Квітка&quot;
          </motion.p>
          <motion.p custom={11} variants={itemVariants} className="font-medium text-2xl text-clay">
          ...
          <Link
            ...
            href="#master-class"
          >
            <motion.span custom={12} variants={itemVariants}>Майстер-класи</motion.span>
          </Link>
        </motion.div>
