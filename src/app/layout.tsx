...
export const metadata: Metadata = {
  title: "Керамічна студія “Квітка” | Гончарство в Києві",
  description:
    "Відкрийте для себе гончарське мистецтво в Києві разом з керамічною студією “Квітка”, де ви можете навчитися гончарства, майстерності ліплення з глини та створення скульптур. Долучайтесь до наших курсів, майстер-класів та особливих програм для дітей та пар, щоб розкрити свій творчий потенціал у затишній атмосфері.",
  keywords:
  ...
  openGraph: {
    ...
    siteName: "Керамічна студія “Квітка” | Гончарство в Києві",
    locale: "uk",
    type: "website",
  },
};
